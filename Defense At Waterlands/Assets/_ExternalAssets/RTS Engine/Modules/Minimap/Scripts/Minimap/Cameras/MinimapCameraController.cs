    ...
    public class MinimapCameraController : MonoBehaviour, IMinimapCameraController
    {
        ...
        public void Init(IGameManager gameMgr)
        {
            ...
            if (followMainCameraRotation) //set the rotation of the minimap camera:
                minimapCamera.transform.rotation = Quaternion.Euler(new Vector3(90.0f, mainCameraController.MainCamera.transform.eulerAngles.y, 0.0f));
        ...
        {
            Vector3 screenCenterWorldPos = mainCameraController.ScreenToWorldPoint(new Vector3(Screen.width / 2, Screen.height / 2, 0.0f), applyOffset: false);
        ...
        private void OnLeftMouseClick(Vector3 hitPoint)
        {
            ...
            mainCameraController.PanningHandler.SetFollowTarget(null);
            // Make the main camera look at the minimap hit position
            mainCameraController.PanningHandler.LookAt(hitPoint, smooth: true, smoothFactor: 0.8f);
        }
