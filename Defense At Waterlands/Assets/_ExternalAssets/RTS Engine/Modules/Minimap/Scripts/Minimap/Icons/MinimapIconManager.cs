...
namespace RTSEngine.Minimap.Icons
{
    ...
    public class MinimapIconManager : ObjectPool<IMinimapIcon, MinimapIconSpawnInput>, IMinimapIconManager
    {
        ...
        [SerializeField, Tooltip("Sprite used as a default minimap icon when the icon for an entity type is not specifically assigned.")]
        ...
        private IMinimapIcon Spawn(IEntity source)
        {
            ...
            MinimapIconSpawnInput input = new MinimapIconSpawnInput(
                sourceEntity: source,
                height,
                source.MinimapIconHandler.IsValid() 
                    ? source.MinimapIconHandler.Data
                    : new IEntityMinimapIconData { changeTransparency = false, changeDarkness = false },
                prefab.Output.transform.rotation);
