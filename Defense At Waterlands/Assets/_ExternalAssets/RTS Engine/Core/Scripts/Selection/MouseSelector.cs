...
namespace RTSEngine.Selection
{
    public class MouseSelector : MonoBehaviour, IMouseSelector
    {
        ...
        {
            if (!nextRangeSelectionSource.IsValid() || !target.instance.IsValid() || !target.instance.Selection.IsValid())
            ...
            {
                Vector3 entityScreenPosition = mainCameraController.MainCamera.WorldToScreenPoint(target.instance.Selection.transform.position);
