...
namespace RTSEngine
{
    public static class RTSHelper
    {
        ...
        public static Vector3 MiddleScreenPoint => new Vector3(Screen.width * 0.5f, Screen.height * 0.5f, 0.0f);
        #endregion
        ...
        public static ErrorMessage IsAttackLOSBlocked (PathDestinationInputData pathDestinationInput, Vector3 testPosition)
        {
            ...
            return IsAttackLOSBlocked(entity.FirstActiveAttackComponent, pathDestinationInput.target.position, testPosition);
        }
        ...
        {
            return attackComponent.LineOfSight.IsObstacleBlocked(testPosition, targetPosition)
